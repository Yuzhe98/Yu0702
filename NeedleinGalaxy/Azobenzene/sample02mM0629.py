...
labelarr1 = np.array(["UV 0 min",  # 0
                      ...
                      "UV 15 min",  # 499 8
                      "UV 20 min",  # 500 9
                      "UV 20 min + Blue 2 min",  # 501 10
                      "UV 20 min + Blue 5 min",  # 502 11
                      "UV 20 min + Blue 5 min + Darkness 5 min",  # 503
                      "UV 20 min + Blue 5 min + Room light 1 min",  # 504
                      "UV 20 min + Blue 5 min + Room light 5 min", # 505
                      "UV 20 min + Blue 5 min + Room light 10 min"  # 506
                        ])
...
ax0.set_ylabel('Absorption')  #, fontsize=18
ax0.legend(loc='upper right', fontsize=14)#
plt.savefig("D:\\Mainz\\JGU\\Specmeter\\report\\sample02mM0629Blue.png",format='png')
plt.show()
...
plt.savefig("D:\\Mainz\\JGU\\Specmeter\\report\\sample02mM0629Bluezoomin2.png",format='png')
plt.show()
...
plt.savefig("D:\\Mainz\\JGU\\Specmeter\\report\\sample02mM0629Bluezoomin1.png",format='png')
plt.show()
